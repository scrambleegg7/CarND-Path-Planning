...
vector<double> Map::getXY(double s, double d){
  ...
  wp_x = this->calcSpline(this->map_waypoints_s, this->map_waypoints_x,s);
  wp_y = this->calcSpline(this->map_waypoints_s, this->map_waypoints_y,s);
  wp_dx = this->calcSpline(this->map_waypoints_s, this->map_waypoints_dx,s);
  wp_dy = this->calcSpline(this->map_waypoints_s, this->map_waypoints_dy,s);
...
// protected members 
double Map::calcSpline(vector<double>  xx, vector<double>  yy, double s) {
